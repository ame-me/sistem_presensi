...
const STUDENTS: Student[] = [
    { id: "st1", nis: "2024001", name: "Ahmad Fauzi", gender: "L", className: "X-IPA-1", classId: "c1" },
    { id: "st2", nis: "2024002", name: "Dewi Lestari", gender: "P", className: "X-IPA-1", classId: "c1" },
    { id: "st3", nis: "2024003", name: "Rizky Pratama", gender: "L", className: "X-IPA-1", classId: "c1" },
    { id: "st4", nis: "2024004", name: "Putri Maharani", gender: "P", className: "X-IPA-1", classId: "c1" },
    { id: "st5", nis: "2024005", name: "Fajar Nugroho", gender: "L", className: "X-IPA-1", classId: "c1" },
    { id: "st6", nis: "2024006", name: "Sari Wulandari", gender: "P", className: "X-IPA-2", classId: "c2" },
    { id: "st7", nis: "2024007", name: "Dimas Ardiansyah", gender: "L", className: "X-IPA-2", classId: "c2" },
    { id: "st8", nis: "2024008", name: "Rina Fitriani", gender: "P", className: "X-IPA-2", classId: "c2" },
    { id: "st9", nis: "2024009", name: "Andi Setiawan", gender: "L", className: "X-IPA-2", classId: "c2" },
    { id: "st10", nis: "2024010", name: "Maya Sari", gender: "P", className: "XI-IPA-1", classId: "c3" },
];
        ...
        set((state) => ({
            waLogs: [
                ...state.waLogs,
                {
                    ...
                    message: `✅ Pengajuan izin untuk *${req.studentName}* (${req.type}) pada ${req.leaveDate} telah diterima. Menunggu persetujuan guru.`,
                    status: "sent" as const,
                    timestamp: new Date().toISOString(),
                },
            ],
            ...
            set((state) => ({
                waLogs: [
                    ...state.waLogs,
                    {
                        ...
                        message: `Pengajuan izin untuk *${lr.studentName}* pada ${lr.leaveDate} telah *${statusText}*.`,
                        status: "sent" as const,
                        timestamp: new Date().toISOString(),
                    },
                ],
