    ...
    return (
        <div className="space-y-6 pb-12 font-sans print:p-0">
            ...
            <div className="hidden print:block text-center mb-8 border-b-2 border-slate-800 pb-4">
                <h1 className="text-2xl font-bold uppercase tracking-tight">Jadwal Pelajaran Siswa</h1>
                <h2 className="text-xl font-semibold mt-1">SMPK SANTA MARIA 2 MALANG</h2>
                <div className="mt-4 flex justify-between items-end px-4">
                    <div className="text-left">
                        <p className="text-sm font-bold">Nama Siswa: <span className="font-normal underline underline-offset-4">{activeChild?.name}</span></p>
                        <p className="text-sm font-bold">Kelas: <span className="font-normal underline underline-offset-4">{activeChild?.cls}</span></p>
                    </div>
                                    ...
                                    <table className="w-full border-collapse">
                                        <thead>
                                            <tr className="text-left">
                                                <th className="pb-4 px-4 text-[10px] font-black text-slate-300 uppercase tracking-[0.2em] w-12 text-center">#</th>
                                                <th className="pb-4 px-4 text-[10px] font-black text-slate-300 uppercase tracking-[0.2em] w-40">Waktu</th>
                                                <th className="pb-4 px-4 text-[10px] font-black text-slate-300 uppercase tracking-[0.2em]">Mata Pelajaran</th>
                                                <th className="pb-4 px-4 text-[10px] font-black text-slate-300 uppercase tracking-[0.2em] w-72">Guru Pengajar</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                                ...
                                                daySchedule.map((item, idx) => (
                                                    <tr key={item.id} className="border-t border-slate-100 hover:bg-slate-50/50 transition-colors">
                                                        <td className="py-6 px-4 text-center">
                                                            <span className="text-xs font-bold text-slate-300 italic">{item.slot}</span>
                                                        </td>
